...
/**
 * 企业操作日志
 * Class CompanyLogModel.class.php
...
class CompanyLogModel extends BaseModel
{
    protected $tableName = 'company_log';
     ...
     * Version: 1.00
     */
    public function addLog($action = COMPANY_ACTION_ADD, $oldData = [], $newData = [], $request = [], $desc = '')
    {
        $data = [];
